...
<head>
    ...
    <title>Intervista avv. Marco Marazzi - ICPN</title>
        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <ol>
                    ...
                    <li>Intervista avv. Marco Marazzi - ICPN</li>
                </ol>
            </div>
                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry entry-single">
                        ...
                        <h2 class="entry-title">
                            <a href="#">Intervista avv. Marco Marazzi - ICPN</a>
                        </h2>

                        <div class="entry-meta">
                            <ul>
                                <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="../team.php">Matteo Hu e Erika Yu</a></li>
                                <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="#">22 May 2021</a></li>
                            </ul>
                        </div>

                        <div class="entry-content text-justify">

                            <h3 id="1">Quali sono secondo te i settori e le opportunità d'investimento in crescita in questo momento? Perché? </h3>
                            ...
                            <h3 id="2">In che modo le aziende italiane e cinesi si sono attivate per far fronte all'emergenza Coronavirus? </h3>
                            ...
                            <h3 id="4">Quali sono le prospettive di carriera nel settore degli investimenti?</h3>
                            ...
                            <h3 id="5">Che tipo di percorso consigli e quali sono le competenze necessarie per operare in questo settore?</h3>
                            ...
                            <h3 id="6">Un consiglio per chi vuole intraprendere questo percorso.</h3>
                ...
                <div class="col-lg-4">
                        <div class="sidebar">
                            ...
                            <div class="sidebar-item categories">
                                <ul>
                                    <li><a href="#1">1. Quali sono secondo te i settori e le opportunità d'investimento in crescita in questo momento? Perché?</a></li>
                                    <li><a href="#2">2. In che modo le aziende italiane e cinesi si sono attivate per far fronte all'emergenza Coronavirus?</a></li>
                                    <li><a href="#3">3. Quali sono le cause principali che rendono difficoltoso gli investimenti cinesi in Italia e quali sono le soluzioni?</a></li>
                                    <li><a href="#4">4. Quali sono le prospettive di carriera nel settore degli investimenti?</a></li>
                                    <li><a href="#5">5. Che tipo di percorso consigli e quali sono le competenze necessarie per operare in questo settore?</a></li>
                                    <li><a href="#6">6. Un consiglio per chi vuole intraprendere questo percorso.</a></li>
                                </ul>
